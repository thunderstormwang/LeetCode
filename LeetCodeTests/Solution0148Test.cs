...
namespace LeetCodeTests
{
    ...
    public class Solution0148Test
    {
        ...
        [TestCase(new int[] { 3, 1, 1, 3 }, new int[] { 1, 1, 3, 3 })]
        [TestCase(new int[] { 3, 3, 3, 1 }, new int[] { 1, 3, 3, 3 })]
        [TestCase(new int[] { }, new int[] { })]
        [TestCase(new int[] { 666 }, new int[] { 666 })]
        public void SortList(int[] input, int[] expected)
        {
