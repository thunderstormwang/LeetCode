...
namespace LeetCodeTests
{
    ...
    public class Solution0092Test
    {
        ...
        [TestCase(new int[] { 1, 2 }, 1, 2, new int[] { 2, 1 })]
        [TestCase(new int[] { 5 }, 1, 1, new int[] { 5 })]
        public void ReverseBetween(int[] inputArray, int left, int right, int[] expectedArray)
        {
            var solution = new Solution0092();

            var list = Utility.BuildListNode(inputArray);
            var actual = solution.ReverseBetween(list, left, right);
