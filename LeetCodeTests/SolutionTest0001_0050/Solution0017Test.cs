...
namespace LeetCodeTests.SolutionTest0001_0050
{
    ...
    public class Solution0017Test
    {
        ...
        public void LetterCombinations_IterativeTest(string input, string[] expectedArray)
        {
        ...
        [TestCase("", new string[] { })]
        [TestCase("2", new string[] { "a", "b", "c" })]
        public void LetterCombinations_RecursiveTest(string input, string[] expectedArray)
        {
