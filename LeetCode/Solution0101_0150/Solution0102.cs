...
public class Solution0102
{
    ...
    private void PreorderSearch(TreeNode root, IList<IList<int>> result, int depth)
    {
        if(root == null)
        {
            return;
        ...
        PreorderSearch(root.left, result, depth + 1);
        PreorderSearch(root.right, result, depth + 1);
    }
}