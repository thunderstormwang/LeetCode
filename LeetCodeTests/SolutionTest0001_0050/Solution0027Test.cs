...
namespace LeetCodeTests.SolutionTest0001_0050
{
    ...
    public class Solution0027Test
    {
        ...
        [TestCase(new int[] { 4, 4 }, 4, 0, new int[] { })]
        public void RemoveElementTest(int[] array, int val, int expectedLength, int[] expectedArray)
        {
            ...
            Array.Copy(array, actualArray, result);
