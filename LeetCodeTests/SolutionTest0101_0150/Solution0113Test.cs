...
public class Solution0113Test
{
    ...
    public void PathSum_Ver1Test(int?[] array, int targetSum, IList<IList<int>> expected)
    {
    ...
    [TestCaseSource(nameof(TestCases))]
    public void PathSum_Ver2Test(int?[] array, int targetSum, IList<IList<int>> expected)
    {
        var root = Utility.BuildTree(array, 0);
