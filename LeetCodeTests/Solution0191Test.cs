...
namespace LeetCodeTests
{
    ...
    public class Solution0191Test
    {
        ...
        [TestCase(11U, 3)]
        [TestCase(128U, 1)]
        [TestCase(4294967290U, 30)]
        [TestCase(4294967293U, 31)]
        [TestCase(4294967295U, 32)]
        public void HammingWeight_ShiftTest(uint input, int expected)
        {
        ...
        [TestCase(4294967293U, 31)]
        [TestCase(4294967295U, 32)]
        public void HammingWeight_DivideTest(uint input, int expected)
        {
